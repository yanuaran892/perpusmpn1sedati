...
import { motion, useScroll, useTransform, Variants, useMotionValue } from "framer-motion"; // Import useMotionValue
...
import GalleryModal from "@/components/GalleryModal"; // Import the new GalleryModal component
  ...
  return (
    <div className="bg-white text-gray-800 font-sans">
      ...
      <main className="pt-16"> {/* Now that box-sizing is border-box, h-16 (4rem) is the correct height */}
        ...
        <SectionWrapper 
          id="librarians" 
          className="bg-gradient-to-b from-blue-50 to-blue-50 overflow-hidden relative" // Changed to gradient and added overflow-hidden, relative
          noContainer
        >
...
const AboutSection = () => {
  ...
  // Framer Motion for 3D tilt effect
  const x = useMotionValue(0);
  const y = useMotionValue(0);
  const rotateX = useTransform(y, [-100, 100], ["15deg", "-15deg"]); // Reduced tilt angle for subtlety
  const rotateY = useTransform(x, [-100, 100], ["-15deg", "15deg"]); // Reduced tilt angle for subtlety
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center"> {/* Added max-w-7xl mx-auto px-4 */}
        ...
        <motion.div
          className="relative h-full flex items-center justify-center rounded-2xl p-4 bg-white shadow-2xl transform-gpu" // Added transform-gpu for performance
        ...
        >
          ...
          <img
            ...
            style={{ transform: "translateZ(50px)" }} // Make image pop out
          />
        </motion.div>
      </div>
    </section>
...
const GallerySection = () => {
  ...
  return (
    <section id="gallery" ref={ref} className="py-16 md:py-24 bg-gradient-to-br from-blue-50 to-indigo-100 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10"> {/* Content wrapper */}
