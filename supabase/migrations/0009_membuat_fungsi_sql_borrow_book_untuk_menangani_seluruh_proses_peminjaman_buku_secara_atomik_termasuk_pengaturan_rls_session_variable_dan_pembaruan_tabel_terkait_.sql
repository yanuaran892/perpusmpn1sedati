...
BEGIN
  ...
  -- Update buku table: decrement jumlah_buku
  UPDATE public.buku
  SET jumlah_buku = (v_current_jumlah_buku - 1)::text
  WHERE id_buku = p_id_buku;

  -- Update siswa table: increment sedang_pinjam
  UPDATE public.siswa
  SET sedang_pinjam = v_current_sedang_pinjam + 1
  WHERE id_nis = p_id_nis;
