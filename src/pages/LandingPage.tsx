...
const LandingPage = () => {
  const heroImages = ["/foto (2).png", "/foto (2).png", "/foto (3).png"]; // Updated to use new hero image
  ...
  return (
    <div className="bg-white text-gray-800 font-sans pt-16">
      ...
      {/* Visi & Misi Section */}
      <section id="vision-mission" className="py-16 px-4 md:py-24 md:px-6 container mx-auto text-center">
        <h3 className="text-3xl md:text-4xl font-bold mb-6">VISI & MISI</h3>
        <p className="max-w-4xl mx-auto text-base md:text-lg text-gray-600 leading-relaxed mb-12 md:mb-16">
          Mewujudkan sekolah yang beriman, bertaqwa, berkarakter, berprestasi, dan peduli lingkungan dengan lulusan yang cerdas, kreatif, kompetitif, serta cinta tanah air.
        </p>
      ...
      {/* Pustakawan Section */}
      <section id="librarians" className="py-16 md:py-24 px-4 container mx-auto text-center">
