    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <GSAPButton onClick={handleAddBook} size="sm">
                  ...
                  {books.map((book) => (
                    <TableRow key={book.id_buku}>
                      ...
                      <TableCell className="text-right">
                        <GSAPButton variant="ghost" size="sm" className="mr-2" onClick={() => handleEditBook(book)}>
                          <Edit className="h-4 w-4" />
                        </GSAPButton>
                        <GSAPButton variant="destructive" size="sm" onClick={() => handleDeleteBook(book.id_buku, book.judul_buku, book.gambar_buku)}>
