...
const GallerySection = () => {
  ...
  return (
    <section id="gallery" ref={ref} className="bg-gradient-to-br from-blue-50 to-indigo-100 py-16 md:py-24 px-4 container mx-auto">
